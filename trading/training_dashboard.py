...
Run: `python trading/training_dashboard.py --log logs/trading_log.csv --refresh 1.0`
Sweep PR (optional sparkline): `python trading/scripts/sweep_tau_conf.py --out logs/pr_curve.csv`
...
def main():
    ...
    ap.add_argument(
        ...
        type=str,
        default=None,
        help="Optional CSV with tau_off precision/recall sweep (from trading/scripts/sweep_tau_conf.py --out ...).",
    )
    args = ap.parse_args()
